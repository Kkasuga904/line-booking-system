...
**リクエスト:**
```
GET /api/capacity-availability?date=2025-09-02&store_id=***REMOVED-ROTATE-CREDENTIAL***
```
...
```javascript
// APIレスポンスを確認
fetch('/api/capacity-availability?date=2025-09-02&store_id=***REMOVED-ROTATE-CREDENTIAL***')
  .then(r => r.json())
