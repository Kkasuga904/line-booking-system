...
```sql
-- クリーンアップ
DELETE FROM reservations WHERE store_id = '***REMOVED-ROTATE-CREDENTIAL***' AND date = '2025-08-30';

-- テスト実行
SELECT * FROM check_and_create_reservation('***REMOVED-ROTATE-CREDENTIAL***', '2025-08-30', '18:00:00', 2, 'test1');
SELECT * FROM check_and_create_reservation('***REMOVED-ROTATE-CREDENTIAL***', '2025-08-30', '18:00:00', 3, 'test2');
SELECT * FROM check_and_create_reservation('***REMOVED-ROTATE-CREDENTIAL***', '2025-08-30', '18:00:00', 1, 'test3'); -- 満席エラー
SELECT * FROM check_and_create_reservation('***REMOVED-ROTATE-CREDENTIAL***', '2025-08-30', '18:00:00', 4, 'test4'); -- 人数超過エラー
```
