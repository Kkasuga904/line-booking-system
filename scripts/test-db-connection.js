...
async function testConnection() {
  ...
  try {
    ...
    console.log('\n3. ***REMOVED-ROTATE-CREDENTIAL***の予約:');
    ...
    if (defaultError) {
      console.error('***REMOVED-ROTATE-CREDENTIAL***予約エラー:', defaultError);
    } else {
      console.log(`***REMOVED-ROTATE-CREDENTIAL***予約: ${defaultReservations.length}件`);
