...
```javascript
// ❌ 古い形式
'https://line.me/R/app/***REMOVED-ROTATE-CREDENTIAL***'

// ✅ 新しい形式
'https://liff.line.me/***REMOVED-ROTATE-CREDENTIAL***'
```
...
// GET /api/liff-health
{
  "status": "healthy",
  "liff": {
    "id": "***REMOVED-ROTATE-CREDENTIAL***",
    "url": "https://liff.line.me/***REMOVED-ROTATE-CREDENTIAL***",
...
```yaml
# .env.yaml
LIFF_ID: "***REMOVED-ROTATE-CREDENTIAL***"
