...
async function checkStoreIds() {
  ...
  if (Object.keys(storeIdCount).length > 1) {
    ...
    console.log('以下のコマンドですべてを***REMOVED-ROTATE-CREDENTIAL***に統一できます:');
    console.log('npm run prevent-issues');
  } else if (!storeIdCount['***REMOVED-ROTATE-CREDENTIAL***']) {
    console.log('❌ ***REMOVED-ROTATE-CREDENTIAL***の予約がありません');
