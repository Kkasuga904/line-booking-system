// Smoke Test Script for LINE Booking System (ES Module version)
// Usage: node smoke-test.mjs [DEPLOYMENT_URL]
...
const DEPLOY_URL = process.argv[2] || 'http://localhost:3000';
